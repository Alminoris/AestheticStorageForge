...
public class HalfcupboardBlockEntity extends BlockEntity implements MenuProvider, ImplementedInventory {

    private final NonNullList<ItemStack> inventory = NonNullList.withSize(4, ItemStack.EMPTY);
    private String name;

    public HalfcupboardBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.HALFCUPBOARD_BLOCK_ENTITY.get(), pos, state);
    }
    ...
    {
        String id = (name != null) ? name : "halfcupboard";
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new HalfcupboardMenu(containerId, playerInventory, this);
    }
}
