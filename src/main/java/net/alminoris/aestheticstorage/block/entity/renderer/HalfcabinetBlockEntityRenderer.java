...
public class HalfcabinetBlockEntityRenderer implements BlockEntityRenderer<HalfcabinetBlockEntity>
{
    public HalfcabinetBlockEntityRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    public void render(HalfcabinetBlockEntity entity, float partialTicks, PoseStack poseStack,
                       MultiBufferSource bufferSource, int combinedLight, int combinedOverlay)
    {
        ...
        Direction facing = entity.getBlockState().getValue(HalfcabinetBlock.FACING);
