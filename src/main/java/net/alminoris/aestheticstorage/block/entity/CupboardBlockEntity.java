...
public class CupboardBlockEntity extends BlockEntity implements MenuProvider, ImplementedInventory {
    ...
    public CupboardBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CUPBOARD_BLOCK_ENTITY.get(), pos, state);
    }
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new CupboardMenu(containerId, playerInventory, this);
    }
}
